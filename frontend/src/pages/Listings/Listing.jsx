      ...
      <div className="containerL">
        <div className="productListing">
          ...
          <div className="content-right">
            <img
              src="https://754969b0.rocketcdn.me/bacola/wp-content/uploads/2021/08/bacola-banner-18.jpg"
            ...
            <div className={`productListingg ${productStyle()}`}>
              {Array.isArray(productState) &&
                productState.map((product, index) => (
                  <Product
                    key={index}
                    data={product}
                    itemViewName={productStyle()}
                  />
                ))}
            </div>
